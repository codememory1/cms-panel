...
use App\Infrastructure\Dto\Builder\DtoConstraintBuilder;
...
abstract class AbstractDataTransfer implements DataTransferInterface
{
    ...
    /**
     * @return array<int, DtoConstraintBuilder>
     */
    private function getAttributes(ReflectionProperty $reflectionProperty): array
    {
        ...
        foreach ($reflectionAttributes as $reflectionAttribute) {
            ...
            if ($attributeInstance instanceof DataTransferConstraintInterface) {
                $attributes[] = new DtoConstraintBuilder($attributeInstance, $reflectionAttribute);
            }
        }
    ...
    private function getConstraintHandler(DtoConstraintBuilder $dtoConstraintBuilder): ?DataTransferConstraintHandlerInterface
    {
        $namespaceHandler = $dtoConstraintBuilder->constraint->getHandler();
